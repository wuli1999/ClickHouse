...
ColumnsDescription QueryLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"os_user", low_cardinality_string, "Operating system username who runs vxdfs-client."},
        {"client_hostname", low_cardinality_string, "Hostname of the client machine where the vxdfs-client or another TCP client is run."},
        {"client_name", low_cardinality_string, "The vxdfs-client or another TCP client name."},
        {"client_revision", std::make_shared<DataTypeUInt32>(), "Revision of the vxdfs-client or another TCP client."},
        {"client_version_major", std::make_shared<DataTypeUInt32>(), "Major version of the vxdfs-client or another TCP client."},
        {"client_version_minor", std::make_shared<DataTypeUInt32>(), "Minor version of the vxdfs-client or another TCP client."},
