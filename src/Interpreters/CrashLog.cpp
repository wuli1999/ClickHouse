...
ColumnsDescription CrashLogElement::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        {"trace", std::make_shared<DataTypeArray>(std::make_shared<DataTypeUInt64>()), "Stack trace at the moment of crash. Each element is a virtual memory address inside vxdfs server process."},
        {"trace_full", std::make_shared<DataTypeArray>(std::make_shared<DataTypeString>()), "Stack trace at the moment of crash. Each element contains a called method inside vxdfs server process."},
        {"version", std::make_shared<DataTypeString>(), "vxdfs server version."},
        {"revision", std::make_shared<DataTypeUInt32>(), "vxdfs server revision."},
