...
void WriteBufferFromS3::finalizeImpl()
{
    ...
    span.addAttribute("vxdfs.s3_bucket", bucket);
    span.addAttribute("vxdfs.s3_key", key);
    span.addAttribute("vxdfs.total_size", total_size);
    ...
    span.addAttributeIfNotZero("vxdfs.multipart_upload_parts", multipart_tags.size());
