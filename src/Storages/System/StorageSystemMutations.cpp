...
ColumnsDescription StorageSystemMutations::getColumnsDescription()
{
    return ColumnsDescription
    {
        ...
        { "mutation_id",                std::make_shared<DataTypeString>(), "The ID of the mutation. For replicated tables these IDs correspond to znode names in the <table_path_in_vxdfs_keeper>/mutations/ directory in vxdfs Keeper. For non-replicated tables the IDs correspond to file names in the data directory of the table."},
        ...
        { "is_killed",                  std::make_shared<DataTypeUInt8>(), "Only available in vxdfs Cloud."},
