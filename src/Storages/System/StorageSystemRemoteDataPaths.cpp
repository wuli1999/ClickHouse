    ...
    : IStorage(table_id_)
{
    ...
    storage_metadata.setColumns(ColumnsDescription(
    {
        ...
        {"local_path", std::make_shared<DataTypeString>(), "Path of vxdfs file, also used as metadata path."},
        {"remote_path", std::make_shared<DataTypeString>(), "Blob path in object storage, with which vxdfs file is associated with."},
